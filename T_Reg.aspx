<%@ Page Language="C#" AutoEventWireup="true" CodeFile="T_Reg.aspx.cs" Inherits="Reg" %>
...
<p><asp:TextBox ID="t_id" runat="server" placeholder="Teacher ID"></asp:TextBox></p>
<p><asp:TextBox ID="txtmail" runat="server" placeholder="E Mail"></asp:TextBox></p>
...
<p><asp:TextBox ID="course" runat="server" placeholder="Course Id"></asp:TextBox></p>
