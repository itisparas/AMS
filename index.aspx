...
<html lang="en">
  ...
  <body>
					...
					<div class="container-fluid">
						<div class="navbar-header">
							<div class="navbar-brand">
								<a href="index.html"><h1>Academic Solutions</h1></a>
							</div>
						</div>
						<div class="menu">
				...
				<div class="col-md-4">
					<div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
						<div class="align-center">
							...
							<div class="ficon">
								<a href="" alt=""></a> <i class="fa fa-long-arrow-right"></i>
                                <a href="Admn_login.aspx" alt=""><input type="Button" value="Log IN"/></a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.8s">
						<div class="align-center">
							...
							<div class="ficon">
								<a href="" alt=""></a> <i class="fa fa-long-arrow-right"></i>
                                <a href="Teach_login.aspx" alt=""><input type="Button" value="Log IN"/></a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="wow flipInY" data-wow-offset="0" data-wow-delay="1.2s">
						<div class="align-center">
							...
							<div class="ficon">
								<a href="" alt=""></a> <i class="fa fa-long-arrow-right"></i>
                                <a href="stu_login.aspx" alt=""><input type="Button" value="Log IN"/></a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="recent">
				<button class="btn-primarys"><h3>Developer Team</h3></button>
				<hr>
			</div>
		</div>
	</div>
