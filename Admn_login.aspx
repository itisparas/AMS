<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admn_login.aspx.cs" Inherits="Admn_login" %>
...
<asp:Button ID="submit" runat="server" Text="Login" BackColor="SkyBlue" OnClick="submit_Click"></asp:Button>
</fieldset>
</form>
</div> 
</center>
